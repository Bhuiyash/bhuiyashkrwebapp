...
export class ExperienceComponent {
  experiences: Experience[] = [
    ...
    },
    {
      ...
      duration: '2023 - Present',
      description:
        'Project: EHRA – Electronic Health Risk Assessment (2025 | US Healthcare)',
      responsibilities: [
    ...
    },
    {
      ...
      responsibilities: [
        'I kept facing a problem to track my expenses and manage my budget effectively. To solve this problem, I decided to develop a budget tracker application for Android using ReactNative.',
